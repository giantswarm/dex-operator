...
- Send a distinctive `User-Agent` (`giantswarm-dex-operator go-github/<version>`) on GitHub API requests instead of go-github's generic default, as the GitHub API asks integrations to do.
